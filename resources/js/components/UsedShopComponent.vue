<template>
    <div class="containe mt-2">
        <div class="d-flex">
            ...
            <Button class="btn btn-success" style="margin-left:4%" data-toggle="modal" data-target="#addPostModal">Create Used Shop</Button>
        </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            fetchusedShop(){
                axios.get('https://admin.globalshopping-mall.site/api/used_shops')
                .then(res => {
                    this.list = res.data;
            ...
            find(){ 
                ...
                axios.get('https://admin.globalshopping-mall.site/api/search_used_shop/'+this.search_name)
                .then(res => {
                    console.log("HI");
            ...
            addPost(){
                ...
                if(this.add.client_name == '' || this.add.image == ''){
                ...
                axios.post('https://admin.globalshopping-mall.site/api/create_used_shop', formData, config)
                .then(res => {
                    if(res.status == 201){
            ...
            editPost(id){
                ...
                let i = 0;
                axios.get('https://admin.globalshopping-mall.site/api/single_used_shop/'+id)
                .then(res => {
                    // console.log(res.data.data);
            ...
            updatePost(){
                ...
                formData.append('client_name', this.update.client_name);
                ...
                axios.post('https://admin.globalshopping-mall.site/api/update_used_shop/'+this.update.id, formData, config)
                .then(res => {
                    if(res.status == 200){
                        location.reload();
                    }
            ...
            activation(id){
                ...
                .then(res => {
                    // console.log(res.data.data);
                    //  shop_name = res.data.data.mall_name;
                    //  merchant = res.data.data.contact_person;
                    //  brand = res.data.data.contact_number;
                    //  category = res.data.data.email_address;
                    //  floor = res.data.data.address;
                    //  mall = res.data.data.zip_code;
                    //  city = res.data.data.city;
                    //  selling_identity = res.data.data.country;
                    //  free_shipping_min_amount = res.data.data.country;
                    //  free_shipping_for_all = res.data.data.country;
                    for(i=0; i<this.merchants.length; i++){
                        if(this.merchants[i].merchant_name == res.data.data[0].merchant_name){
                ...
                .then(res => {
                    axios.put('https://admin.globalshopping-mall.site/api/update_used_shop/'+id,{
                        merchant: merchant,
