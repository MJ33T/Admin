                        ...
                        <tbody>
                            <tr v-for='item in pagination' :key='item.id'>
                                ...
                                <td style="text-align:center">
                                    <a class="btn btn-primary mr-2" href="#editPostModal" data-toggle="modal" @click="editPost(item.id);">View / Edit</a>
    ...
    export default {
        ...
        methods:{
            ...
            addPost(){
                ...
                formData.append('promotion_by', this.merchant);
            ...
            editPost(id){
                ...
                .then(res => {
                    ...
                    this.update.merchant = res.data.data[0].merchant_id;
                    this.update.sub_brand = res.data.data[0].sub_brand_id,
            ...
            updatePost(){
                ...
                formData.append('promotion_by', "Merchant");
            ...
            activation(id){
                ...
                .then(res => {
                    ...
                    sub_brand = res.data.data[0].sub_brand_id;
