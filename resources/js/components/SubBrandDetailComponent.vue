                        ...
                        <tbody>
                            <tr v-for='item in pagination' :key='item.id'>
                                ...
                                <td style="text-align:center">
                                    <a class="btn btn-primary" href="#editPostModal" data-toggle="modal" @click="editPost(item.GUID);">View / Edit</a>
                                    <button class="btn btn-info mt-3 mb-3">Update Shipping Method</button>
                                    <button class="btn text-white" :style="[item.activation == 1 ? {'background-color' : 'green'} : {'background-color' : 'red'}]" onclick="confirm('Confirm want to change activation?') || event.stopImmediatePropagation()" @click="activationUpdate(item.GUID);">Active / Deactive</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12 mt-3" >
                                <div class="form-group" v-for="(input,k) in update_variations"  :key="k">
                                    ...
                                    <div class="row">
                                        <!-- <div class="col-sm">
                                            <select class="form-control" v-model="input.name">
                                                <option value="" disabled>Variation</option>
                                                <option v-for="(sub_brand, index) in update_sub_brand_variation" :key="index" v-bind:value="sub_brand.id">{{ sub_brand.name }}</option>
                                            </select>
                                        </div> -->
                                        <div class="col-sm">
                                        ...
                                        <div class="col-sm">
                                            <div class="row">
                                                <div class="col-sm-2">
                                                    <span>
                                                        <!-- <button class="btn btn-danger" @click="update_remove(k)" v-show="k || ( !k && update_variations.length > 1)">-</button> -->
                                                    </span>
                                                </div>
                                                <div class="col-sm-2">
                                                    <span>
                                                        <!-- <button class="btn btn-success" @click="update_add(k)" v-show="k == update_variations.length-1">+</button> -->
                                                    </span>
                                                </div>
                                            </div>
                                        </div>
...
<script>
    ...
    export default {
        ...
        methods:{
            ...
            update_add(index) {
                this.update_variations.push({ variation: '', attribute:'', surcharge:'', stock:'' });
            },
            update_remove(index) {
                this.update_variations.splice(index, 1);
            },
            selectVariation(){
                ...
                .then(res => {
                    ...
                    this.file1 = res.data.data[0].image;
                    this.file2 = res.data.data[0].image1;
                    this.file3 = res.data.data[0].image2;
                    this.file4 = res.data.data[0].image3;
                    this.file5 = res.data.data[0].image4;
                    this.file6 = res.data.data[0].video;
            ...
            excelExport(){
                ...
                const fileName = "SubBrandDetails";
            ...
            find(){ 
                ...
                axios.get('https://admin.globalshopping-mall.site/api/search_sub_brand_detail/'+this.search_name)
                .then(res => {
            ...
            editPost(id){
                ...
                .then(res => {
                    ...
                    // console.log(res.data.data[0].sub_brand_name)
                    ...
                    .then(res => {
                        ...
                        .then(res => {
                            console.log(res.data.data);
                            temp_one = res.data.data
                            for(i=0; i<temp.length; i++){
                                console.log(temp_one[i]);
                                if(temp_one[i] == null){
                                    axios.post('https://admin.globalshopping-mall.site/api/create_sub_brand_detail_variation', {GUID:temp[i].GUID, variation:temp[i].id, attribute:attribute, surcharge:0, stock:0})
                                    .then(res => {
                                        if(res.status == 201){
                                            console.log("HI");
                                        }
                                    }).catch(err => {console.log(err);});
                                    // console.log(temp[i].GUID);
                                    // console.log(temp[i].id);
                                }
                            }
                            this.update_variations = temp_one;
            ...
            activationUpdate(id){
                ...
                .then(res => {
                    ...
                    sub_brand_detail_id = res.data.data[0].id;
                ...
                .then(res => {
                    ...
                    axios.put('https://admin.globalshopping-mall.site/api/update_sub_brand_detail/' + sub_brand_detail_id, {
                        GUID:GUID, 
