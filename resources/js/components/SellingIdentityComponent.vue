<template>
    <div class="containe mt-2">
        <div class="d-flex">
            ...
            <Button class="btn btn-success" style="margin-left:2%" data-toggle="modal" data-target="#addPostModal">Create Selling Identity</Button>
        </div>
            ...
            <div class="modal-dialog modal-lg modal-dialog-centered">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-2">Selling Identity</div>
                            <div class="col-sm-10">
                                <input type="text" class="form-control" v-model="add.selling_identity">
                            </div>
                            <div class="col-sm-2 mt-3">Description</div>
                            <div class="col-sm-10 mt-3">
                                <textarea cols="30" rows="5" class="form-control"  v-model="add.description"></textarea>
                            </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-sm-2">Selling Identity</div>
                            <div class="col-sm-10">
                                <input type="text" class="form-control"  v-model="update.selling_identity">
                            </div>
                            <div class="col-sm-2 mt-3">Description</div>
                            <div class="col-sm-10 mt-3">
                                <textarea cols="30" rows="5" class="form-control"  v-model="update.description"></textarea>
                            </div>
                            <div class="col-sm-2 mt-3">Activation</div>
                            <div class="col-sm-10 mt-3">
                                <div class="form-check-inline">
    ...
    export default {
        ...
        methods:{
            ...
            find(){ 
                ...
                axios.get('https://admin.globalshopping-mall.site/api/search_selling_identity/'+this.search_name)
                .then(res => {
                    // console.log("HI");
            ...
            excelExport(){
                ...
                const fileName = "SellingIdentity";
            ...
            addPost(){
                ...
                axios.post('https://admin.globalshopping-mall.site/api/create_selling_identity', this.add)
                .then(res => {
                    if(res.status == 201){
            ...
            editPost(id){
                // this.update.fill(id);
                axios.get('https://admin.globalshopping-mall.site/api/single_selling_identity/'+id)
                .then(res => {
                    console.log(res.data.data)
                    this.update.id = res.data.data.id,
                    this.update.selling_identity = res.data.data.selling_identity,
            ...
            updatePost(){
                axios.put('https://admin.globalshopping-mall.site/api/update_selling_identity/'+this.update.id, this.update)
                .then(res => {
                    if(res.status == 200){
                        location.reload();
                    }
            ...
            activation(id){
                let activationCode;
                let selling_identities;
                let description;
                axios.get('https://admin.globalshopping-mall.site/api/single_selling_identity/'+id)
                .then(res => {
                    //console.log("Response = "+res.data.data.activation);
                     selling_identities = res.data.data.selling_identity;
                ...
                .then(res => {
                    axios.put('https://admin.globalshopping-mall.site/api/update_selling_identity/' + id, {selling_identity:selling_identities, description:description, activation: activationCode}).then(res => {location.reload();}).catch(err => {console.log("Error = "+err);})
