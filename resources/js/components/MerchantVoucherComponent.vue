                    ...
                    <div class="modal-body">
                        ...
                        <!-- <div class="row">
                            <div class="col-sm-12">
                                ...
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="voucher_belongs_to" v-bind:value="this.gsm" v-model="add.voucher_belongs_to">GSM
                                    </label>
                                </div>
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="voucher_belongs_to" v-bind:value="this.merchant" v-model="add.voucher_belongs_to">Merchant
                                    </label>
                                </div>
                                <div class="form-check-inline">
                                    <label class="form-check-label">
                                        <input type="radio" class="form-check-input" name="voucher_belongs_to" v-bind:value="this.by_other_mall" v-model="add.voucher_belongs_to">By Other Mall
                                    </label>
                                </div>
                            </div>
                        </div> -->
        ...
        methods:{
            ...
            fetchSubBrand(){
                ...
                .then(res => {
                    ...
                    for(i=0; i<this.merchant_sort.length; i++){
                        if(this.merchant_sort[i].merchant_id == this.session){
                            this.sub_brands[j] = this.merchant_sort[i];
                            j++;
                        }
                    }
                }).catch(err => {console.log(err);});
            ...
            addPost(){
                ...
                formData.append('voucher_belongs_to', this.add.discount_amount);
            ...
            editPost(id){
                ...
                .then(res => {
                    ...
                    this.update.merchant = this.session,
                    ...
                    this.update.voucher_belongs_to = 1;
                    // console.log(this.update.activation);
                }).catch(error => {console.log(error);});
            },
            ...
            updatePost(){
                ...
                formData.append('maximum_usage', this.update.maximum_usage);
            ...
            activation(id){
                ...
                .then(res => {
                    ...
                    merchant = res.data.data[0].merchant_id;
