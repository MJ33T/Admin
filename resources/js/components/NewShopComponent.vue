    ...
    export default {
        ...
        methods:{
            ...
            find(){ 
                ...
                axios.get('https://admin.globalshopping-mall.site/api/search_new_shop/'+this.search_name)
                .then(res => {
                    console.log("HI");
            ...
            addPost(){
                ...
                axios.post('https://admin.globalshopping-mall.site/api/create_new_shop', formData, config)
                .then(res => {
                    if(res.status == 201){
            ...
            editPost(id){
                ...
                let i = 0;
                axios.get('https://admin.globalshopping-mall.site/api/single_new_shop/'+id)
                .then(res => {
                    // console.log(res.data.data);
                    ...
                    // console.log(res.data.data[0].free_shipping_for_all);
            ...
            updatePost(){
                ...
                // console.log(this.update.free_shipping_for_all);
                ...
                axios.post('https://admin.globalshopping-mall.site/api/update_new_shop/'+this.update.id, formData, config)
                .then(res => {
                    if(res.status == 200){
                        location.reload();
                    }
            ...
            activation(id){
                ...
                .then(res => {
                    axios.put('https://admin.globalshopping-mall.site/api/update_new_shop/'+id,{
                        merchant: merchant,
                        shop_name: shop_name,
